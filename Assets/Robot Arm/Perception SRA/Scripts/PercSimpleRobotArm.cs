...
public class PercArticulation {
    ...
    ///  Constructor
    /// </summary>
    public PercArticulation(Transform articulation) {
...
public class PercSimpleRobotArm : Agent
{
    ...
    // Dictionary where the key is a string and the value is an PercArticulation
    public Dictionary<string, PercArticulation> articulations = new Dictionary<string, PercArticulation>();
    ...
    {
        target.GetComponent<PercSpawnTarget>().TargetSpawn();
    }
    ...
    public void SetUpArticulations(){
        articulations.Add("armBase", new PercArticulation(armBase));
        articulations.Add("arm0", new PercArticulation(arm0));
        articulations.Add("arm1", new PercArticulation(arm1));
    }
    ...
    public void moveArticulation(string articulationName, float x, float y, float z){
        ...
        PercArticulation articulation = articulations[articulationName];
